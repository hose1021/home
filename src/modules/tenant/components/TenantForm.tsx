...
export function TenantForm() {
  ...
  return (
    <form action={formAction} className="space-y-4 max-w-md">
      <div>
        <label htmlFor="name" className="block text-sm font-medium">{tt("name")}</label>
        <input
          id="name"
          name="name"
          required
      ...
      <div>
        <label htmlFor="slug" className="block text-sm font-medium">{tt("slug")}</label>
        <input
          id="slug"
          name="slug"
          required
          ...
          className="mt-1 block w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900"
        />
        <p className="mt-1 text-xs text-zinc-400">{tt("slugHint")}</p>
      </div>
      <div>
        <label htmlFor="address" className="block text-sm font-medium">{tt("address")}</label>
        <input
          id="address"
          name="address"
          className="mt-1 block w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900"
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="phone" className="block text-sm font-medium">{tt("phone")}</label>
          <input
            id="phone"
            name="phone"
            type="tel"
