          ...
          <div key={p.id} className="flex items-center gap-3 px-4 py-3 transition-colors hover:bg-muted/25 sm:px-5">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-sm text-muted-foreground">· {MONTHS[p.periodMonth - 1]} {p.periodYear}</span>
              </div>
            ...
            {canEdit && (
              <div className="flex items-center gap-1 shrink-0">
                <Button variant="ghost" size="icon-sm" onClick={() => openEdit(p)} aria-label="Изменить платёж"><IconEdit /></Button>
                <AlertDialog>
                  <AlertDialogTrigger render={
                    <Button variant="ghost" size="icon-sm" className="text-muted-foreground hover:text-destructive" aria-label="Удалить платёж"><IconTrash /></Button>
                  } />
                  <AlertDialogContent>
                    <AlertDialogHeader>
