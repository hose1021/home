  ...
  return (
    <div className="page-shell">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <p className="text-sm text-muted-foreground">Реестр жильцов</p>
          <h1 className="page-heading mt-1">Собственники</h1>
          <p className="page-description">Профили, роли и квартиры · {ownersWithRoles.length} чел.</p>
        </div>
      </div>
      <OwnerTable
