  ...
  return (
    <div className="page-shell">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <p className="text-sm text-muted-foreground">{t("announcements.infoCenter")}</p>
          <h1 className="page-heading mt-1">{t("announcements.title")}</h1>
          <p className="page-description">{t("announcements.description")}</p>
        </div>
