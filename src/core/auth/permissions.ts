...
const rolePermissions: Record<Role, Permission[]> = {
  ...
  management_member: ["building:read", "unit:read", "owner:read", "resident:read", "voting:read", "voting:write", "meeting:read", "meeting:write", "protocol:read", "protocol:sign", "finance:read", "charge:read", "payment:read", "fund:read", "budget:read", "budget:write", "contractor:read", "contractor:write", "work_order:read", "ticket:read", "document:read", "announcement:read", "announcement:write", "notification:send"],
